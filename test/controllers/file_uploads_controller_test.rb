...
class FileUploadsControllerTest < ActionController::TestCase
  ...
  test "should create file_upload" do
    assert_difference('FileUpload.count') do
      post :create, file_upload: { file_name: @file_upload.file_name, file_path: @file_upload.file_path, mime_type: @file_upload.mime_type, user_id: @file_upload.user_id }
    end
  ...
  test "should update file_upload" do
    patch :update, id: @file_upload, file_upload: { file_name: @file_upload.file_name, file_path: @file_upload.file_path, mime_type: @file_upload.mime_type, user_id: @file_upload.user_id }
    assert_redirected_to file_upload_path(assigns(:file_upload))
  end
